    ...
    private function migrateContact(int $id, int $leadId): int
    {
        foreach ($this->b24From->getCRMScope()->contact()->list(
            ...
            $fields = [
                ...
                'UF_CRM_1767852013'   => $contact->getUserfieldByFieldName('UF_CRM_1748963459285') ? $this->prepareMultiUserField($contact->getUserfieldByFieldName('UF_CRM_1748963459285'), $this->workTypes) : false,
                'UF_CRM_1767852159'   => $contact->getUserfieldByFieldName('UF_CRM_1748963667349') ? $this->prepareMultiUserField($contact->getUserfieldByFieldName('UF_CRM_1748963667349'), $this->transportTypes) : false,
                'UF_CRM_1767848097'   => $contact->getUserfieldByFieldName('UF_CRM_1748963727117'),
                'UF_CRM_1767848117'   => $contact->getUserfieldByFieldName('UF_CRM_1748963778708'),
                'UF_CRM_1767852279'   => $contact->getUserfieldByFieldName('UF_CRM_1751724478550') ? $this->prepareMultiUserField($contact->getUserfieldByFieldName('UF_CRM_1751724478550'), $this->transportBrands) : false,
                'UF_CRM_1767848206'   => $this->clientGrades[$contact->getUserfieldByFieldName('UF_CRM_1751724556654')] ?? '',
            ];
